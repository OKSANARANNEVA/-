...
INSERT INTO categories VALUES
	...
	(2,'Классическая и современная поэзия'),
	(3,'Фэнтази'),
	(4,'Science Fiction'),
	(5,'Биография'),
	(6,'Триллеры'),
...
INSERT INTO books (id,name,pages,rating, description) VALUES
	(1,'Судьба человека',370,100,'Проза «Судьба человека» –  рассказ советского писателя Михаила Шолохова. Написан в 1956 году. Первая публикация — газета «Правда», номера за 31 декабря 1956 и 1 января 1957 года[1].'),
